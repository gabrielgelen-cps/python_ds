...
export name='gabrielgelen-cps'
export email="gabriel.gelen@etec.sp.gov.br"
export repositorio="https://github.com/gabrielgelen-cps/python_ds.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="aula-$(date +%m%d)"
